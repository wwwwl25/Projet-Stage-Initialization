...
$sql = "SELECT id, name, description, prix, photo FROM vitamines";
...
<head>
    <meta charset="UTF-8">
    <title>Nos Produits - Vitamines</title>
...
<body>
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<a href='details.php?id=" . urlencode($row["id"]) . "&table=vitamines' class='buy-button'>🛒 Acheter</a>";
            echo "</div>";
        }
    } else {
